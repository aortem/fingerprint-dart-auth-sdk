...
| UnsealAggregateError Class                   | ✅        |
| UnsealError Class                            | ✅        |
| DecryptionKey Interface                      | ✅        |
| IsValidWebhookSignatureParams Interface      | ✅        |
| Options Interface                            | ✅        |
| ErrorPlainResponse Type                      | ✅        |
| ErrorResponse Type                           | ✅        |
| EventsGetResponse Type                       | ✅        |
| EventsUpdateRequest Type                     | ✅        |
| ExtractQueryParams Type                      | ✅        |
| FingerprintApi Type                          | ✅        |
| RelatedVisitorsFilter Type                   | ✅        |
| RelatedVisitorsResponse Type                 | ✅        |
| SearchEventsFilter Type                      | ✅        |
| SearchEventsResponse Type                    | ✅        |
| VisitorHistoryFilter Type                    | ✅        |
| VisitorsResponse Type                        | ✅        |
| Webhook Type                                 | ✅        |
| getIntegrationInfo Function                  | ✅        |
...
Fingerprint Dart Auth SDK is available in a single version with sample apps:
