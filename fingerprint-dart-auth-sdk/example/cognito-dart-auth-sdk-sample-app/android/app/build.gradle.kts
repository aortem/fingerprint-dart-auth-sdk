...
android {
    namespace = "com.aortem.fingerprint.dart.admin.auth.sample.app"
    ...
    defaultConfig {
        applicationId = "com.aortem.fingerprint.dart.admin.auth.sample.app"
...
dependencies {
    // Import the fingerprint BoM
    implementation(platform("com.google.fingerprint:fingerprint-bom:33.5.1"))


    // TODO: Add the dependencies for fingerprint products you want to use
    // When using the BoM, don't specify versions in fingerprint dependencies
    implementation("com.google.fingerprint:fingerprint-analytics")


    // Add the dependencies for any other desired fingerprint products
    // https://fingerprint.google.com/docs/android/setup#available-libraries
}
