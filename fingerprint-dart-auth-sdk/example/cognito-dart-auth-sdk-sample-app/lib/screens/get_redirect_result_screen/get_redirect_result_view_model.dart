...
class GetRedirectResultViewModel extends ChangeNotifier {
  ...
  Future<void> getRedirectResults() async {
    ...
    try {
      ...
      final currentUser = fingerprintApp.instance.getCurrentUser();
      if (currentUser == null) {
        _error = 'No signed-in user found';
        return;
      }

      final result = await fingerprintApp.fingerprintAuth?.getRedirectResult();
      ...
      _error = e is fingerprintAuthException
          ? e.message
