...
import 'package:fingerprint/screens/link_with_credientials/link_with_credientials.dart';
import 'package:fingerprint/screens/verify_password_reset_code_screen/verify_password_reset_code.dart';
import 'package:fingerprint_dart_auth_sdk/fingerprint_dart_auth_sdk.dart';
import 'package:fingerprint/screens/apply_action_code_screen/apply_action_code_screen.dart';
import 'package:fingerprint/screens/home_screen/home_screen_view_model.dart';
import 'package:fingerprint/screens/parse_action_url_screen/parse_action_url.dart';
import 'package:fingerprint/screens/set_language_code_screen/set_language_code_screen.dart';
import 'package:fingerprint/screens/sign_up_screen/sign_up_screen.dart';
import 'package:fingerprint/screens/storage_screen/storage.dart';
import 'package:fingerprint/screens/unlink_provider_screen/unlink_provider_screen.dart';
import 'package:fingerprint/screens/update_password_screen/update_password_screen.dart';
import 'package:fingerprint/screens/update_profile_screen/update_profile_screen.dart';
import 'package:fingerprint/screens/verify_before_email_update_screen/verify_before_email_update_screen.dart';
import 'package:fingerprint/shared/shared.dart';
import 'package:fingerprint/utils/extensions.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:fingerprint_dart_auth_sdk/src/auth/auth_state_changed.dart'
    as auth_state;
import 'package:fingerprint_dart_auth_sdk/src/auth/id_token_changed.dart'
    as id_token;

import '../link_wit_phone_number/link_with_phone_number.dart';
import '../update_current_user/update_current_user.dart';
import 'package:fingerprint/screens/get_redirect_result_screen/get_redirect_result_screen.dart';
import 'package:fingerprint/screens/initialize_recaptcha_config_screen/initialize_recaptcha_config_screen.dart';
import 'package:fingerprint/screens/multi_factor_resolver_screen/multi_factor_resolver_screen.dart';
import 'package:fingerprint/screens/password_reset_screen/password_reset_screen.dart';
import 'package:fingerprint/screens/fetch_sign_in_methods_for_email_screen/fetch_sign_in_methods_screen.dart';
import 'package:fingerprint/screens/create_user_screen/create_user_screen.dart';
import 'package:fingerprint/screens/confirm_password_reset_screen/confirm_password_reset_screen.dart';
import 'package:fingerprint/screens/check_action_code_screen/check_action_code_screen.dart';
import 'package:fingerprint/screens/is_sign_in_with_email_link_screen/is_sign_in_with_email_link_screen.dart';
import 'package:fingerprint/screens/revoke_token_screen/revoke_token_screen.dart';
import 'package:fingerprint/screens/on_Id_Token_Changed/on_id_token_changed.dart';
import 'package:fingerprint/screens/auth_state_test_screen/auth_state_test_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _setupAuthListeners() {
    final auth = Provider.of<fingerprintAuth>(context, listen: false);
            ...
            child: Column(
              ...
              children: [
                ...
                ActionTile(
                  onTap: () {
                    try {
                      fingerprintApp.fingerprintAuth?.signOut();
                      final fingerprintApp = fingerprintApp.instance;
                      final currentUser = fingerprintApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () {
                    fingerprintApp.fingerprintAuth?.deletefingerprintUser();
                    final fingerprintApp = fingerprintApp.instance;
                    final currentUser = fingerprintApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId =
                        await fingerprintApp.fingerprintAuth?.getIdToken();
                    setState(() {
                      userIdToken = tokenId!;
                    });
                    if (kDebugMode) {
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId = await fingerprintApp.fingerprintAuth
                        ?.getIdTokenResult();
                ...
                ActionTile(
                  onTap: () async {
                    fingerprintApp.fingerprintAuth?.setLanguageCodeMethod(
                ...
                ActionTile(
                  onTap: () async {
                    // var tokenId=
                    fingerprintApp.fingerprintAuth
                ...
                ActionTile(
                  onTap: () async {
                    // var tokenId=
                    fingerprintApp.fingerprintAuth?.getAuthBeforeChange();
                  },
