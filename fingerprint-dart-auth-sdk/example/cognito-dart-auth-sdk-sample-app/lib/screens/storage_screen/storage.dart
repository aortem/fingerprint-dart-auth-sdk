...
class _StorageExampleState extends State<StorageExample> {
  final fingerprintStorage storage = fingerprintApp.instance.getStorage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('fingerprint Storage Example'),
      ),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Upload File to fingerprint Storage'),
            ),
          ],
        ),
      ),
