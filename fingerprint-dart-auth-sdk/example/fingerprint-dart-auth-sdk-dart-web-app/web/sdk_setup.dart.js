...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    FingerprintAuth$(apiKey) {
      if (apiKey.length === 0)
        A.throwExpression(A.ArgumentError$("API key must be provided either directly or via environment variables.", null));
      return new A.FingerprintAuth(apiKey);
    },
    FingerprintAuth: function FingerprintAuth(t0) {
      this.__FingerprintAuth_apiKey_F = t0;
    },
    ...
    main() {
      var t3,
        t1 = document,
        output = type$.DivElement._as(t1.querySelector("#output")),
        t2 = t1.querySelector("#btn-init");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        A._EventStreamSubscription$(t2._target, t2._eventType, t3._eval$1("~(1)?")._as(new A.main_closure(output)), false, t3._precomputed1);
      }
      t1 = t1.querySelector("#btn-verify");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure0(output)), false, t2._precomputed1);
      }
    },
  ...
  A.FingerprintAuth.prototype = {
    verify$1(payload) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$self = this, t2, response, t3, t4, url, t1;
      var $async$verify$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              url = A.Uri_parse("https://api.fingerprintjs.com/verify");
              t1 = $async$self.__FingerprintAuth_apiKey_F;
              t1 === $ && A.throwLateFieldNI("apiKey");
              t2 = type$.String;
              $async$goto = 3;
              return A._asyncAwait(A.post(url, payload, A.LinkedHashMap_LinkedHashMap$_literal(["Authorization", "Bearer " + t1, "Content-Type", "application/json"], t2, t2)), $async$verify$1);
            case 3:
              // returning from await.
              response = $async$result;
              if (response.statusCode === 200) {
                t1 = response.headers;
                t3 = A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1));
                t4 = response.bodyBytes;
                $async$returnValue = t3.decode$1(0, t4).length !== 0 ? type$.Map_String_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1)).decode$1(0, t4), null)) : A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              } else
                throw A.wrapException(A.Exception_Exception("Verification failed: " + response.get$body(0)));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
      });
      return A._asyncStartSync($async$verify$1, $async$completer);
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t5._add$1(0, request._bodyBytes);
  ...
  A.Response.prototype = {
    get$body(_) {
      return A.encodingForContentTypeHeader(A._contentTypeForHeaders(this.headers)).decode$1(0, this.bodyBytes);
    }
  };
  ...
  A.main_closure.prototype = {
    call$1(__wc0_formal) {
      var auth, e, t1, exception;
      type$.MouseEvent._as(__wc0_formal);
      try {
        auth = A.FingerprintAuth$("my-secret-api-key");
        t1 = auth.__FingerprintAuth_apiKey_F;
        t1 === $ && A.throwLateFieldNI("apiKey");
        B.DivElement_methods.set$text(this.output, "\u2705 SDK Initialized with key: " + t1);
      } catch (exception) {
        e = A.unwrapException(exception);
        B.DivElement_methods.set$text(this.output, "\u274c Error initializing SDK: " + A.S(e));
      }
    },
    $signature: 46
  };
  A.main_closure0.prototype = {
    call$1(__wc1_formal) {
      return this.$call$body$main_closure(type$.MouseEvent._as(__wc1_formal));
    },
    $call$body$main_closure(__wc1_formal) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$self = this, auth, response, e, exception, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              auth = A.FingerprintAuth$("my-secret-api-key");
              $async$goto = 6;
              return A._asyncAwait(auth.verify$1('{"visitorId":"12345"}'), $async$call$1);
            case 6:
              // returning from await.
              response = $async$result;
              B.DivElement_methods.set$text($async$self.output, "\u2705 Verify success: " + A.S(response));
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              B.DivElement_methods.set$text($async$self.output, "\u274c Verify failed: " + A.S(e));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 51, 0, 0);
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 6);
    var _;
    _instance_1_i(_ = A._StreamController.prototype, "get$_add", "_add$1", 11);
    ...
    _static_1(A, "case_insensitive_map_CaseInsensitiveMap__canonicalizer$closure", "CaseInsensitiveMap__canonicalizer", 16);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Instantiation, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._asyncStarHelper_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._LinkedCustomHashMap_closure, A._EventStreamSubscription_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.CanonicalizedMap_keys_closure, A.post_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A._readBody_closure, A._readBody_closure0, A.ByteStream_toBytes_closure, A.MediaType_toString__closure, A.expectQuotedString_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.Highlighter$__closure, A.Highlighter$___closure, A.Highlighter$__closure0, A.Highlighter__collateLines_closure, A.Highlighter__collateLines_closure1, A.Highlighter__collateLines__closure, A.Highlighter_highlight_closure, A.main_closure, A.main_closure0]);
    ...
    _inheritMany(A.Converter, [A._UnicodeSubsetEncoder, A._UnicodeSubsetDecoder, A.Base64Encoder, A.JsonDecoder, A.Utf8Encoder, A.Utf8Decoder]);
...
//# sourceMappingURL=sdk_setup.dart.js.map
